...
const Footer = () => {
    return (
        <footer className='min-h-[250px] flex flex-col gap-11 justify-start p-7 text-white w-full bg-black  '>
            <div className='flex justify-evenly'>
                <ul>
                 ...
                 <ul>
                    ...
                    <li><Link to="/reviews">Past Papers</Link></li>
                   <li><Link to="/upload/review">Post a Review</Link></li>
            ...
            <h1 className='text-center '> © {new Date().getFullYear()}  UniPastPapers. All rights reserved. | Developed with ❤️ by Faizan Ahmed</h1>
        </footer>
    )
}
