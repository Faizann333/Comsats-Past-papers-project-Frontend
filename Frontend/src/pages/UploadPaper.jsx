...
// import { PastPapersContext } from '../components/store/PaperListContext';
// import { ThemeContext } from '../components/store/ThemeContext';
// import { postPaper , postFile } from '../apis/paperApi';
// import { AuthContext } from '../components/store/AuthContext';
...
//     const FileUploadResponse = await postFile(formData);
//     console.log('File uploaded successfully:', FileUploadResponse);

//     const fileUrl = FileUploadResponse.fileUrl;
...
//       semester,
//       uploader: user.registrationNumber,
//       fileUrl, // Include the file URL or identifier returned from the upload response
//     };
//     const data = await postPaper(paperDetail);
